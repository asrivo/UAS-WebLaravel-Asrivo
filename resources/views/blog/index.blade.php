    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4 border-0">
                ...
                <div class="card-body px-0">
                    <div class="small text-muted">Diposting {{ $article->created_at->format('d F Y') }} - Kategori <a href="/artikel?kategori={{ $articles[0]->category->slug }}" class="text-decoration-none">{{ $articles[0]->category->nama}}</a></div>
